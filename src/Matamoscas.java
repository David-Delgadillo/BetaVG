...
public class Matamoscas extends Base {
    
    // *************************** CONSTRUCTOR *********************************
    /**
     * Matamoscas
     * 
     * Metodo constructor usado para crear el objeto Matamoscas
     ...
     * 
     */
    public Matamoscas(int iX, int iY , int iAncho, int iAlto) {
